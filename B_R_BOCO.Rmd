...
plutôt que de calculer la loi a posteriori à partir de la vraisemblance, on compare des données simulées à partir du modèle à des statistiques résumées des données observées. Le schéma général de cette approche est le suivant :
...
$$
avec $d\left(\cdot, \cdot\right)$ une distance et $\varepsilon$, une mesure de tolérance. Les paramètres acceptés forment une approximation de la loi a posteriori.
...
### Rappel du principe ABC dansnotre contexte
